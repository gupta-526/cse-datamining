...
def main():
	...
	decision_clf = DecisionTreeClassifier(criterion="entropy", splitter = "random", 
		random_state=100)
	...
	#for mushroom
	decision_clf_m = DecisionTreeClassifier(criterion="entropy", splitter = "random", 
		random_state=100)
	...
	#for glass
	decision_clf_g = DecisionTreeClassifier(criterion="entropy", splitter = "random", 
		random_state=100)
